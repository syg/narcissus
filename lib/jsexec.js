...
Narcissus.interpreter = (function() {
    ...
    function chooseLabel(b, s) {
        if (b === s.hl)
            return new Label(H, L);
        if (b === s.hh)
            return new Label(H, L);
        if (b === s.ll)
            return new Label(L, L);
        return new Label(L, H);
    }
    ...
    function joinLabel(k1, k2) {
        if (!k1 && !k2)
            return null;
        if (!k1) k1 = new Label(L, H);
        if (!k2) k2 = new Label(L, H);
        ...
        switch (n.type) {
          case FUNCTION:
            if (n.functionForm !== parser.DECLARED_FORM) {
                if (!n.name || n.functionForm === parser.STATEMENT_FORM) {
                    ...
                    let ll = new Object;
                    let lh = new Object;
                    x.scope = { hl: hl, hh: hh, ll: ll, lh: lh,
                                base: {}, parent: x.scope };
          ...
          case WITH:
            ...
            if (x.pc.c === H && x.pc.i === L)
                x.scope = { hl: t, hh: {}, ll: {}, lh: {},
                            base: {}, parent: x.scope };
            else if (x.pc.c === H && x.pc.i === H)
                x.scope = { hl: {}, hh: t, ll: {}, lh: {},
                            base: {}, parent: x.scope };
            else if (x.pc.c === L && x.pc.i === L)
                x.scope = { hl: {}, hh: {}, ll: t, lh: {},
                            base: {}, parent: x.scope };
            else if (x.pc.c === L && x.pc.i === H)
                x.scope = { hl: {}, hh: {}, ll: {}, lh: t,
                            base: {}, parent: x.scope };
    ...
    var FOp = FunctionObject.prototype = {
        ...
        __call__: function (t, a, x) {
            ...
            if (x.pc.c === H && x.pc.i === L)
                x2.scope = { hl: activation, hh: {}, ll: {}, lh: {},
                             base: base, parent: this.scope };
            else if (x.pc.c === H && x.pc.i === H)
                x2.scope = { hl: {}, hh: activation, ll: {}, lh: {},
                             base: base, parent: this.scope };
            else if (x.pc.c === L && x.pc.i === L)
                x2.scope = { hl: {}, hh: {}, ll: activation, lh: {},
                             base: base, parent: this.scope };
            else if (x.pc.c === L && x.pc.i === H)
                x2.scope = { hl: {}, hh: {}, ll: {}, lh: activation,
                             base: base, parent: this.scope };
            try {
                x2.execute(f.body);
            } catch (e if e === RETURN) {
    ...
    function evaluate(s, f, l) {
        ...
        var x = new ExecutionContext(GLOBAL_CODE, new Label(L, H));
