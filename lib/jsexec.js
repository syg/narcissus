...
Narcissus.interpreter = (function() {
    ...
    /*
     * This functions takes a function and extracts the values from 
     * x and y and then applys the function to x and y.
     * 
     * 
     * 
     */
     ...
     *
     * Value ::= RawValue
     *        |  LabeledValue of RawValue * Label
     *
     * That is, references are always labeled, but values might or might not
     * be labeled.
     */
    ...
    // If r instanceof Reference, v === getRawValue(r); else v === r.  If passed, rn
    ...
    function execute(n, x) {
        ...
        var oldpc, slow;
        var rawValueWhile, whileD, dLeft, dRight;
        var funcStorage;
        ...
        switch (n.type) {
          ...
          case SWITCH:
            s = getRawValue(execute(n.discriminant, x));
            a = n.cases;
          ...
          case DO:
            ...
            } while (getRawValue(execute(n.condition, x)));
            break;
          ...
          case RETURN:
            // Check for returns with no return value
        	  if(n.value){
        		  ...
        		  x.result = getRawValue(execute(n.value, x));
        	  }else{
        		  x.result = undefined;
        	  }
          ...
          case IN:
            ...
            //r = getRawValue(execute(c[0], x)) in getRawValue(execute(c[1], x));
            break;
