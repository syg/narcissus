...
Narcissus.interpreter = (function() {
    ...
    var narcissusGlobal = {
        ...
        Function: function Function(dummy) {
            ...
            var s = { hl: {}, hh: {}, ll: {}, lh: global,
                      base: mkGlobalBase(global), parent: null };
    ...
    var FOp = FunctionObject.prototype = {
        ...
        __call__: function (t, a, x) {
            ...
            var f = this.node;
            if (x.pc.c === H && x.pc.i === L)
                x2.scope = { hl: new Activation(f, a), hh: {}, ll: {}, lh: {},
                            base: {}, parent: this.scope};
            else if (x.pc.c === H && x.pc.i === H)
                x2.scope = { hl: {}, hh: new Activation(f, a), ll: {}, lh: {},
                            base: {}, parent: this.scope};
            else if (x.pc.c === L && x.pc.i === L)
                x2.scope = { hl: {}, hh: {}, ll: new Activation(f, a), lh: {},
                            base: {}, parent: this.scope};
            else if (x.pc.c === L && x.pc.i === H)
                x2.scope = { hl: {}, hh: {}, ll: {}, lh: new Activation(f, a),
                            base: {}, parent: this.scope};
            try {
                x2.execute(f.body);
            } catch (e if e === RETURN) {
